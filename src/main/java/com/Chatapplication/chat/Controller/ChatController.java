...
import com.Chatapplication.chat.model.ChatMessage;
...
public class ChatController {
    ...
    @SendTo("/topic/private.{recipientUsername}")
    public ChatMessage sendToOne(@Payload ChatMessage chatMessage, @DestinationVariable String recipientUsername) {
        return chatMessage;
    }
    /**
